...
var TableResultAction = function TableResultAction(startPoint, where, action, domTable) {
  ...
  /**
   * Set the startPoint of action.blade.php.
   */
  ...
  /**
   * Create action.blade.php cell object.
   *
  ...
  /**
   * Get action.blade.php to be applied on the cell.
   *
   * @param {object} cell virtual table cell to apply action.blade.php
   */
  ...
  this.getActionList = function () {
    ...
    while (canContinue) {
      ...
      if (!cell) {
        canContinue = false;
        return _actionCellList;
      } // Define action.blade.php to be applied in this cell
...
/**
*
* Where action.blade.php occours enum.
*/
...
/**
*
* Requested action.blade.php to apply enum.
*/
...
/**
*
* Result action.blade.php to be executed enum.
*/
    ...
    value: function handleKeyMap(event) {
      ...
      if (keyName === 'TAB' && !this.options.tabDisable) {
        ...
        if (this.context.invoke(eventName) !== false) {
          event.preventDefault(); // if keyMap action.blade.php was invoked
